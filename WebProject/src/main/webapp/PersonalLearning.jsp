...
<div class="d1">
    ...
    <ul id="pictures">
        <li style="margin-left:200px">
            <img src="images/algebra.jpg" height="300px" width="350px" >
            <br>
            <a href="algebra.html">Algebra</a>
        </li>

        <li style="margin-left:140px">
            <img src="images/Geometry.jpg" height="300px" width="350px" >
            <br>
            <a href="geo-knowledge.html">Geometry</a>
        </li>
        <li style="margin-left:200px">
            <img src="images/5th-8th.jpg" height="300px" width="350px" >
            <br>
            <a href="#math">5th grade - 8th grade Math</a>
        </li>
    </ul>
</div>
